...
import org.wit.boitcrp.fragments.RunFragment

interface ItemListenerRun {
    fun onItemClick(item: Item)
}

class ItemAdapterForRun(private var items: List<Item>,
                  private val listener: RunFragment
) :
    RecyclerView.Adapter<ItemAdapterForRun.MainHolder>() {
    ...
    class MainHolder(private val binding : CardItemBinding) :
        ...
        fun bind(item: Item, listener: RunFragment) {
